...
function extract(request, response) {
    ...
    if (blog.length) {
      ...
      $('div.heading-inner div.heading-content, div.promo-content-section, div.rte-inner.rte-headings, div.col-lg-12 div.accordion div.accordion-section, table tbody').each(function () {
